...
function loadWelcomeContent (){
    return `<div class="content">
                ...
                <div class="content">
                    <h2>Como Funciona</h2>
                    <p>
                        Para iniciar sua exploração, basta selecionar uma das operações <strong><a href="https://pt.wikipedia.org/wiki/CRUD" target="_blank">CRUD</a></strong> disponíveis no menu inferior. 
